...
class Main():
    def __init__(self):
        st.set_page_config(
                    ...
                    page_icon='Hypothyroidism/app/icon/cilab.png',
                    layout="wide",
                    )
        ...
        if st.session_state.page == 1:
            hypothyroidism(path="Hypothyroidism/models_file/StackingModel (1).sav")
    ...
    def home(self):
        ...
        with col1:
            st.image('Hypothyroidism/app/icon/icon.png',width=400)
        with col2:
        ...
        st.image("Hypothyroidism/app/icon/fluxograma.png",width=900)
        ...
        st.subheader("Apoio")
        st.image('Hypothyroidism/app/icon/Ufersa.png', caption='UFERSA', width=70)
